...
%  Parent node 
\node (app) {App.jsx\\\textit{Top-level Router using React Router DOM}\\routes to 8 pages};

%  Route components (fan layout) 
\node (home) [below left=2.8cm and 4.2cm of app] {Home.jsx\\\textit{props: none}\\displays profile + summary};
\node (education) [below left=5.8cm and 4cm of app] {Education.jsx\\\textit{props: none}\\renders academic data};
\node (skills) [below left=4.5cm and -1cm of app] {Skills.jsx\\\textit{props: none}\\lists technical stack};
\node (projects) [below right=4.5cm and -1cm of app] {Projects.jsx\\\textit{props: none}\\portfolio component};
\node (experience) [below right=2.8cm and 4cm of app] {Experience.jsx\\\textit{props: none}\\professional experience};
\node (achievements) [below right=5.8cm and 4cm of app] {Achievements.jsx\\\textit{props: none}\\certifications and awards};
\node (thermostat) [below right=7.5cm and -1cm of app] {Thermostat.jsx\\\textit{props: none}\\uses components from Lab 5};
\node (timer) [below left=7.5cm and -1cm of app] {Timer.jsx\\\textit{props: none}\\uses components from Lab 6};
...
\node (tempdisplay) [below=1.8cm of thermostat,xshift=-0.9cm] {TemperatureDisplay.jsx\\\textit{props: \texttt{\symbol{123}temperature, onChange\symbol{125}}}};
\node (tempcontrols) [below=1.8cm of thermostat,xshift=4.3cm] {TemperatureControls.jsx\\\textit{props: \texttt{\symbol{123}increase, decrease\symbol{125}}}};
\node (tempinf) [below=3.3cm of thermostat,xshift=-0.9cm] {TemperatureInF.jsx\\\textit{props: \texttt{\symbol{123}celcius\symbol{125}}}};
\node (tempinc) [below=3.3cm of thermostat,xshift=4.3cm] {TemperatureInC.jsx\\\textit{props: none}};
...
\node (title) [below left=2cm and 1cm of timer] {Title.jsx\\\textit{props: \texttt{\symbol{123}text\symbol{125}}}};
\node (timesetter) [below left=4cm and 0cm of timer] {TimeSetter.jsx\\\textit{props: \texttt{\symbol{123}hours, minutes, seconds, onTimeChange, disabled\symbol{125}}}};
\node (ctrlbtns) [below right=2cm and -3cm of timer] {ControlButtons.jsx\\\textit{props: \texttt{\symbol{123}isActive, onStart, onStop, onReset, hasTime\symbol{125}}}};
\node (timerdisplay) [below right=4cm and -4cm of timer] {TimerDisplay.jsx\\\textit{props: \texttt{\symbol{123}hours, minutes, seconds, isActive, isFinished\symbol{125}}}};
