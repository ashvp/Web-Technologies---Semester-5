...
All components render properly in Chrome and Edge browsers.  
The webpage was version-controlled and pushed to GitHub for public access:
\begin{center}
\href{https://github.com/ashvp/face-attendance}{\texttt{https://github.com/ashvp/face-attendance}}


\end{center}

\newpage
\section*{Lab Exercise 1 - Question 2: CV Webpage using HTML and CSS}
...
\begin{center}
    \includegraphics[width=\textwidth]{Lab1/5.png}\\
    \textbf{Screenshot 2: Projects}
\end{center}
\vspace{1em}
...
The webpage is version-controlled and hosted on GitHub for open access:
\begin{center}
\href{https://github.com/ashvp}{\texttt{https://github.com/ashvp}}
\end{center}
